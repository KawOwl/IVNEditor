...
export const VIRTUAL_IDS = {
  ...
  /** Focus Injection（见 packages/core/src/focus.ts）：focus 元信号 + top N 相关 segment IDs */
...
export async function assembleContext(options: AssembleOptions): Promise<AssembledContext> {
  ...
  // Focus Injection（见 packages/core/src/focus.ts 和 .claude/plans/focus-injection.md）
  //
